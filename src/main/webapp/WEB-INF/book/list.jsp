...
<script type="text/javascript" >
    ...
    $(function (){
        $("#bookMongo").bootstrapTable({
            url:"<%=request.getContextPath()%>/book/findMongo.do",
           // method:"get",
            ...
            columns:[
                ...
                {field:'bookprice',title:'图书价格',width:100,sortable:true},


                {field:'booktypename',title:'类型',width:'5%',/*  formatter:function(value,row,index){
                        var s =value.booktypename;
                        alert(s)
                        console.info(s);
                        if(value.booktypename!=null){
                            return s;
                        }else{
                            return "";
